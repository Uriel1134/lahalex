          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div className="order-2 lg:order-1">
              ...
              >
                ...
                <a
                  href="/nous-contacter"
                  className="hero-button inline-block border-2 border-[#770D28] text-[#770D28] px-8 py-3 rounded-lg font-medium hover:bg-[#770D28] hover:text-white transition-colors"
                >
