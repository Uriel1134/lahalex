    ...
    <main className="relative w-full bg-white overflow-x-hidden">
      ...
      >
        <div className="vision-content">
          ...
          <p className="text-gray-700 text-lg leading-8 mb-4">
            Nos expertises s’inscrivent particulièrement dans les domaines des sciences juridiques,
            des sciences de la santé et des sciences de l’économie et de la gestion, où l’accès à une information rigoureuse, actualisée et
