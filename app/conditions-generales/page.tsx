        ...
        <section className="bg-white py-8 sm:py-12 md:py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-6 sm:mb-8 lg:mb-12">
              <h1 className="font-gobold text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-gray-700 mb-4 sm:mb-6 leading-tight text-balance">
                CONDITIONS GÉNÉRALES DE VENTE ET D'ABONNEMENT (CGVA)
              </h1>
              <div className="text-base sm:text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
                <p className="mt-3 sm:mt-4 text-xs sm:text-sm text-gray-500">Version : Août 2025</p>
              </div>
            </div>
            ...
            <div className="max-w-5xl mx-auto">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                <div className="p-4 sm:p-6 md:p-8 space-y-6 sm:space-y-8">
                  ...
                  <section>
                    <h2 className="text-xl sm:text-2xl font-bold text-[#C8A96B] mb-3 sm:mb-4 text-balance">
                      DISPOSITIONS PRÉLIMINAIRES
                    </h2>
                  ...
                  <section>
                    ...
                    <div className="space-y-4 sm:space-y-6">
                      <div>
                        ...
                        <ul className="list-disc list-inside space-y-1 sm:space-y-2 text-gray-600 ml-2 sm:ml-4 text-sm sm:text-base">
                  ...
                  <section>
                    ...
                    <div className="space-y-4 sm:space-y-6">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 leading-relaxed mt-2 sm:mt-3 text-sm sm:text-base">
                  ...
                  <section>
                    ...
                    <div className="space-y-4 sm:space-y-6">
                      ...
                      <div>
                        <h3 className="text-base sm:text-lg font-semibold text-gray-700 mb-2 sm:mb-3">8.3 Validité</h3>
                        <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                  ...
                  <section>
                    ...
                    <div className="space-y-4 sm:space-y-6">
                        ...
                        <div className="space-y-3">
                          <div>
                            <h4 className="text-sm sm:text-base font-medium text-gray-700 mb-2">
                              9.1.1 Prérequis Techniques et Responsabilités du Client
                            </h4>
                            <p className="text-gray-600 leading-relaxed mb-2 text-sm sm:text-base">
                              Le Client reconnaît et accepte expressément :
                            </p>
                            <ul className="list-disc list-inside space-y-1 text-gray-600 ml-2 sm:ml-4 text-sm sm:text-base">
                          ...
                          <div>
                            <h4 className="text-sm sm:text-base font-medium text-gray-700 mb-2">9.1.2 Disponibilité des Services</h4>
                            <p className="text-gray-600 leading-relaxed mb-2 text-sm sm:text-base">
                          ...
                          <div>
                            <h4 className="text-sm sm:text-base font-medium text-gray-700 mb-2">9.1.3 Support Technique</h4>
                            <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                          ...
                          <div>
                            <h4 className="text-sm sm:text-base font-medium text-gray-700 mb-2">9.1.4 Interdictions Absolues</h4>
                            <p className="text-gray-600 leading-relaxed mb-2 text-sm sm:text-base">
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          <div>
                            <h4 className="text-sm sm:text-base font-medium text-gray-700 mb-2">9.2.1 Principe de Facturation Structurelle</h4>
                            <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                          ...
                          <div>
                            <h4 className="text-sm sm:text-base font-medium text-gray-700 mb-2">9.2.2 Obligations Déclaratives du Client</h4>
                            <p className="text-gray-600 leading-relaxed mb-2 text-sm sm:text-base">
                          ...
                          <div>
                            <h4 className="text-sm sm:text-base font-medium text-gray-700 mb-2">9.2.3 Contrôles et Vérifications par LAHALEX</h4>
                            <p className="text-gray-600 leading-relaxed mb-2 text-sm sm:text-base">
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          <div>
                            <h4 className="text-sm sm:text-base font-medium text-gray-700 mb-2">9.3.1 Attribution des Identifiants</h4>
                            <p className="text-gray-600 leading-relaxed mb-2 text-sm sm:text-base">
                          ...
                          <div>
                            <h4 className="text-sm sm:text-base font-medium text-gray-700 mb-2">9.3.2 Caractère Strictement Personnel des Accès</h4>
                            <p className="text-gray-600 leading-relaxed mb-2 text-sm sm:text-base">
                          ...
                          <div>
                            <h4 className="text-sm sm:text-base font-medium text-gray-700 mb-2">9.3.3 Obligations de Sécurité</h4>
                            <p className="text-gray-600 leading-relaxed mb-2 text-sm sm:text-base">
                          ...
                          <div>
                            <h4 className="text-sm sm:text-base font-medium text-gray-700 mb-2">9.3.4 Mesures de Protection et Sanctions</h4>
                            <p className="text-gray-600 leading-relaxed mb-2 text-sm sm:text-base">
                          ...
                          <div>
                            <h4 className="text-sm sm:text-base font-medium text-gray-700 mb-2">9.3.5 Responsabilité en cas d'Usage Non Autorisé</h4>
                            <p className="text-gray-600 leading-relaxed mb-2 text-sm sm:text-base">
                  ...
                  <div className="border-t-2 border-[#C8A96B] pt-8 mt-8">
                    <div className="text-center mb-6 sm:mb-8">
                      <h1 className="font-gobold text-xl sm:text-2xl md:text-3xl lg:text-4xl text-gray-700 mb-4 sm:mb-6 leading-tight text-balance">
                        CONDITIONS GÉNÉRALES DE VENTE - LOGICIELS LAHALEX
                      </h1>
                      <div className="text-base sm:text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
                        <p className="mt-3 sm:mt-4 text-xs sm:text-sm text-gray-500">Version : Septembre 2025</p>
                        <p className="text-xs sm:text-sm text-gray-500">Document contractuel opposable</p>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50 p-4 sm:p-6 rounded-lg mt-8 border border-[#C8A96B]/20">
