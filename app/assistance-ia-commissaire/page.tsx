    ...
    >
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        ...
        <section className="mb-16">
          <h1
            ref={titleRef}
            className="assistance-commissaire-title text-4xl md:text-5xl font-gobold mb-6 leading-tight"
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href="/essai-gratuit"
              className="assistance-commissaire-button inline-block text-black px-8 py-3 rounded-lg font-medium transition-colors text-center"
              style={{
            ...
            <a
              href="/nous-contacter"
              className="assistance-commissaire-button inline-block px-8 py-3 rounded-lg font-medium transition-colors text-center"
              style={{
