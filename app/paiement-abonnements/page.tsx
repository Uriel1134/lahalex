              ...
              <button
                ...
                className={`pricing-tab px-4 sm:px-6 py-2 sm:py-3 font-medium transition-all text-xs sm:text-sm hover:shadow-lg ${
                  activeTab === tab.id
                    ...
                    : "bg-white text-[#770D28] border border-[#770D28] hover:bg-[#fdf2f8]"
                }`}
  ...
  <div className="bg-white border border-gray-200 rounded-lg flex flex-col">
    <div className="p-6 lg:p-8 flex-1 flex flex-col">
      ...
      <div className="mt-auto">
        <a
          href="/nous-contacter"
          className="w-full bg-[#770D28] text-white py-3 rounded-lg font-medium hover:bg-[#5a0a1f] inline-block text-center font-sf-pro"
        >
          Demandez un devis
        </a>
      </div>
