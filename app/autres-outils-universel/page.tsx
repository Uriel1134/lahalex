          ...
          >
            {[
              ...
              },
              {
                ...
                desc: "Des guides pratiques conçus pour maîtriser les exigences académiques et professionnelles en sciences juridiques, Sciences de la santé et sciences de l'économie et de la gestion. Elles couvrent des formats essentiels comme le cas pratique, le commentaire d'arrêt, la dissertation, l'analyse de cas cliniques, les études économiques, ainsi que la rédaction de rapports et d'autres écrits professionnels.",
                utilite:
              ...
              },
              {
                ...
                desc: "Lahalex vous accompagne dans tous vos défis professionnels grâce à des contenus d'experts reconnus en sciences juridiques, Sciences de la santé et sciences de l'économie et de la gestion : actualités en temps réel, articles de référence, formation continue et analyses commentées.",
                utilite:
              ...
              },
              {
                ...
                desc: "Agenda récapitulatif des séminaires, colloques et conférences en sciences juridiques, Sciences de la santé et sciences de l'économie et de la gestion à ne pas manquer, avec la mise à disposition d'un compte rendu pour chaque événement manqué.",
                utilite:
