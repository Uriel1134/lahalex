...
export default function NotairePage() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(".assistance-notaire-image", 
        ...
        { 
          ...
          ease: "power3.out",
          scrollTrigger: {
            trigger: ".assistance-notaire-image",
            start: "top 80%",
    ...
    <div ref={mainRef} className="flex flex-col min-h-screen bg-white font-sf-pro relative overflow-hidden">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        ...
        <section className="mb-16">
          <h1 ref={titleRef} className="assistance-notaire-title font-gobold text-3xl sm:text-4xl lg:text-5xl text-[#770D28] mb-6 lg:mb-8 leading-tight">
        ...
        {/* Image */}
        <section className="mb-16">
          <div className="assistance-notaire-image aspect-video max-w-4xl mx-auto overflow-hidden">
            <Image
              src="/images/assistance-ia-notaire.png"
      ...
      <style jsx global>{`
        ...
        .assistance-notaire-title {
          opacity: 0;
        }

        .assistance-notaire-button {
          opacity: 0;
        }

        .assistance-notaire-image {
          opacity: 0;
        }
