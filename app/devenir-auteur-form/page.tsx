...
export default function DevenirAuteurForm() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF] flex flex-col relative overflow-hidden">
      ...
      <main
        ref={mainRef}
        className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12 relative z-10"
      >
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 xl:gap-20 items-start">
          ...
          <div className="flex-1 lg:max-w-2xl">
            ...
            <section ref={contentRef} className="space-y-6">
              <h2 className="hero-title text-[#C8A96B] text-2xl lg:text-3xl font-semibold mb-6">
                Pourquoi publier chez LAHALEX ?
              </h2>
              ...
              <div className="space-y-10 text-gray-700">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-2 text-gray-800">
                    Renforcement de l'expertise et crédibilité
                  </h3>
                  <p className="text-base leading-relaxed">
          ...
          <aside className="w-full lg:w-96 lg:flex-shrink-0 self-start mt-0 lg:mt-[588px]">
            ...
            >
              <h3 className="text-[#C8A96B] text-xl font-semibold mb-6">Inscrivez-vous</h3>
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                <div>
                  ...
                  <input
                    id="nom"
                    type="text"
                    className="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#C8A96B] focus:border-transparent transition-all"
                ...
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 sm:gap-0">
                    <select
                      id="indicatif"
                      className="w-full sm:w-auto sm:min-w-[140px] sm:max-w-[200px] border border-gray-300 rounded-lg sm:rounded-l-lg sm:rounded-r-none px-3 py-3 bg-white text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#C8A96B] focus:border-transparent"
                      defaultValue={"+225"}
                    >
                    ...
                    <input
                      id="tel"
                      type="tel"
                      className="w-full sm:flex-1 border border-gray-300 sm:border-l-0 rounded-lg sm:rounded-l-none sm:rounded-r-lg px-4 py-3 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#C8A96B] focus:border-transparent"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor="file">
                    Cliquez ici pour ajouter une pièce
                  </label>
                  <div className="relative">
                    <input
                      id="file"
                      type="file"
                      className="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm text-gray-700 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-[#C8A96B] file:text-gray-800 hover:file:bg-[#B8934F] focus:outline-none focus:ring-2 focus:ring-[#C8A96B] focus:ring-offset-2"
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <div className="flex items-center gap-2">
                      <button
                        type="button"
                        className="text-xs text-gray-600 underline hover:text-[#C8A96B] transition-colors"
                      >
                        Choisir un fichier
                      </button>
                ...
                <div>
                  ...
                  <textarea
                    id="message"
                    className="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#C8A96B] focus:border-transparent transition-all resize-none"
                    rows={4}
                ...
                <div className="flex justify-end">
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center border-2 border-[#C8A96B] text-[#C8A96B] rounded-lg px-5 py-2 text-sm font-semibold hover:bg-[#FFF8EC] focus:outline-none transition-all"
                  >
                    Envoyer
                  </button>
                </div>
