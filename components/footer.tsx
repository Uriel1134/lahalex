...
const socialIcons = [
  ...
  {
    href: "https://www.facebook.com/profile.php?id=61585199090936",
...
export function Footer() {
  return (
    <footer
      className="py-4 relative overflow-hidden border-t-4"
      style={{
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-3">
          ...
          <div>
            <h4 className="font-gobold text-sm mb-1 uppercase">INFORMATIONS & CONTACTS</h4>
            ...
            <div className="space-y-0.5 text-sm font-sf-pro">
              <div className="flex items-center space-x-1.5">
                ...
                <p>Service technique : 0147352775</p>
              </div>
              ...
              <div className="flex items-center space-x-1.5">
                ...
                <p>Bénin Réclamation : 0147352773</p>
              </div>
              <div className="flex items-center space-x-1.5">
                <ContactIcon>
                  <svg className="w-3 h-3 text-gray-600" fill="currentColor" viewBox="0 0 24 24">
                 ...
                 <p> Niger Réclamation : +22788015352</p>
              </div>
               <div className="flex items-center space-x-1.5">
                <ContactIcon>
                  <svg className="w-3 h-3 text-gray-600" fill="currentColor" viewBox="0 0 24 24">
                 ...
                 <p> Sénégal Réclamation : +221706678471</p>
              </div>
              <div className="flex items-center space-x-1.5">
                <ContactIcon>
                  <svg className="w-3 h-3 text-gray-600" fill="currentColor" viewBox="0 0 24 24">
                ...
                <p>Togo Réclamation : +22892645823</p>
              </div>
              ...
              <div className="flex items-center space-x-1.5">
                ...
                <a
                  href="mailto:contact@lahalex.com"
          ...
          <div>
            <h4 className="font-gobold text-sm mb-1 uppercase">ADRESSES</h4>
            ...
            <div className="space-y-0.5 text-sm font-sf-pro">
              <div className="flex items-start space-x-1.5">
                ...
                <div>
                  <p>Rue de la Côte fleurie, Saint-Jean-les-deux-jumeaux, 77660, <strong>France</strong></p>
              ...
              <div className="flex items-start space-x-1.5">
                ...
                >
                 ...
                 <p>Route Université,Tahoua,<strong>Niger</strong></p>
              </div>
                <div className="flex items-start space-x-1.5">
                <div
                  className="w-3 h-3 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"
                ...
                >
                  ...
                  <p>RN1-Zac mbao, Rufisque, Dakar,  <strong>Sénégal</strong></p>
              </div>
              <div className="flex items-start space-x-1.5">
                <div
                  className="w-3 h-3 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"
                ...
                <p>Rue de la liberté, quartier Agbadegbe, Lomé, <strong>Togo</strong></p>
              </div>
            </div>
          </div>
          ...
          <div>
            <h4 className="font-gobold text-sm mb-1 uppercase">SUIVEZ-NOUS SUR</h4>
            ...
            <div className="flex space-x-2">
              {socialIcons.map((icon, i) => (
                <Link
                  ...
                  style={{ color: BRAND_TEXT, backgroundColor: "transparent" }}
                >
                  <svg
        ...
        <div
          className="mt-3 pt-3 text-sm font-sf-pro"
          style={{ borderTop: `1px solid ${BRAND_BORDER}` }}
        >
          <div className="flex flex-wrap justify-center gap-3 text-center">
            <Link href="/conditions-generales" className="hover:opacity-70 uppercase">
              CONDITIONS GÉNÉRALES DE VENTE ET D&apos;UTILISATION
            </Link>

            <Link href="/politique-confidentialite" className="hover:opacity-70 uppercase">
