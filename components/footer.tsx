...
export function Footer() {
  ...
  return (
    <footer ref={footerRef} className="bg-[#770D28] text-white py-12 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="font-gobold text-lg mb-4 uppercase">INFORMATIONS & CONTACTS</h4>
          ...
          {/* Suivez-nous */}
          <div>
            <h4 className="font-gobold text-lg mb-4 uppercase">SUIVEZ-NOUS SUR</h4>
